...
(function () {
    var newLink = [{
		href: 'http://evangogh.github.io/second-site/?utm_campaign=amber&utm_source=alpha&utm_medium=apple&utm_term=ancient&utm_content=ants'
    }, {
        href: 'http://evangogh.github.io/second-site/?utm_campaign=beige&utm_source=bravo&utm_medium=banana&utm_term=best&utm_content=beast'
	}, {
        href: 'http://evangogh.github.io/second-site/?utm_campaign=brown&utm_source=bingo&utm_medium=bear&utm_term=barley&utm_content=banter'
    }, {
        href: 'http://evangogh.github.io/second-site/?utm_campaign=chartreuse&utm_source=charlie&utm_medium=cherry&utm_term=crazy&utm_content=creature'
    }, {
        href: 'http://evangogh.github.io/second-site/?utm_campaign=drab&utm_source=delta&utm_medium=dairy&utm_term=dainty&utm_content=daisy'
    }, {
        href: 'http://evangogh.github.io/second-site/?utm_campaign=ecru&utm_source=echo&utm_medium=eggplant&utm_term=eager&utm_content=eel'
    }, {
        href: 'http://evangogh.github.io/second-site/?utm_campaign=fuschia&utm_source=foxtrot&utm_medium=figs&utm_term=fantastic&utm_content=fish'
    }, {	
...
(function () {
    ...
    function randSites() {
        ...
        for (var i = 0; i < pageLinks.length; ++i) {
            if (pageLinkClass.test(pageLinks[i].className)) {
                link = newLink[Math.floor(Math.random() * newSite.length)];
                pageLinks[i].href = link.href;
                //pageLinks[i].firstChild.nodeValue = link.text;
                pageLinks[i].target = '_blank';
            }
